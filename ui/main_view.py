...
def build_main_view(
    ...
    def relatorio_lista_chamada_backup(e=None):
        try:
            ...
            tickets = [t for t in tickets if t.get("status") not in HIDE_STATUSES]
    ...
    def ask_reset_day(e=None):
        show_snack("Botão Zerar dia clicado.")
    ...
    # zerar_btn = ft.Container(
    #    padding=ft.padding.symmetric(horizontal=12, vertical=8),
    #    border_radius=10,
    #    border=ft.border.all(1, Colors.OUTLINE_VARIANT),
    #    ink=True,
    #    on_click=ask_reset_day,
    #    content=ft.Row(
    #        spacing=6,
    #        controls=[
    #            ft.Icon(Icons.DELETE_SWEEP, size=18),
    #            ft.Text("Zerar dia", size=13, weight=FontWeight.W_700),
    #        ],
    #    ),
    # )
